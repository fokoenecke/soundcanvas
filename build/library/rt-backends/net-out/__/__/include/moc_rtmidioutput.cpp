/****************************************************************************
** Meta object code from reading C++ file 'rtmidioutput.h'
**
...
#include "../../../../../../../library/include/rtmidioutput.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'rtmidioutput.h' doesn't include <QObject>."
...
const QMetaObject drumstick::rt::MIDIOutput::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_drumstick__rt__MIDIOutput.data,
      qt_meta_data_drumstick__rt__MIDIOutput,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *drumstick::rt::MIDIOutput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_drumstick__rt__MIDIOutput.stringdata0))
        return static_cast<void*>(const_cast< MIDIOutput*>(this));
