...
#include "../../../utils/metronome/metronome.h"
...
const QMetaObject Metronome::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Metronome.data,
      qt_meta_data_Metronome,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Metronome::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "SequencerEventHandler"))
        return static_cast< SequencerEventHandler*>(const_cast< Metronome*>(this));
